...
{
    Pimpl(AudioSlaveProcess* parent, HeelpProcessesChildApplication* app) : parent_(parent), app_(app), receivedAudioDeviceManagerState_(false)
    {
    }
    ...
    HeelpProcessesChildApplication* app_;
    Atomic<int> receivedAudioDeviceManagerState_;
};

AudioSlaveProcess::AudioSlaveProcess(HeelpProcessesChildApplication* app)  : pimpl_(new Pimpl(this, app))    {}
